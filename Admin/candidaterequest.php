...
include("../Admin/Adminmenu.php");
		...
		<?php
$result=mysql_query("select * from requesttable where approved='no' and requesttype='Candidate'");  
	...
	?>
		...
		while($row=mysql_fetch_array($result))
			...
			echo '<tr>
					...
					<td>'.$row['year'].'</td>';
					?>
					 <td><a href="candidaterequest.php?updateID=<?php echo $row['Student_ID'];?>" style="text-decoration: none;height: 10px;background-color: #29d6bc;width: 100px;color: #fff4f4;">Approve</a></td><td>
					 	<a href="candidaterequest.php?resetID=<?php echo $row['Student_ID'];?>" style="text-decoration: none;height: 10px;background-color: #29d6bc;width: 100px;color: #fff4f4;">DisApprove</a>
					 </td>
					<?php
				echo '</tr>';
		        }
				...
				mysql_query("insert into account values('identity(1,1)','$fn','$ln','$sex','$age','$un','$pw','$requesttype','1','$photopath','$sid')");
					 //echo "<meta http-equiv='refresh' content='0'>";
					     ...
					     // log file
                                    ...
                                    $body=$row1['fname'].'  '.$row1['lname'].' '."  is accept request  successfully";
					 ...
					 //echo "<meta http-equiv='refresh' content='0'>";
					     ...
					     // log file
                                    ...
                                    $sql2="select*from account where username='$username'";
                                                      $qry2=mysql_query($sql2);
                                                      $row1=mysql_fetch_array($qry2);
                                    $body=$row1['fname'].'  '.$row1['lname'].' '."  is reject apply request  successfully";
                                   
                                    $sql1="insert into logfiles values('','$username','$date','$body')";
                                    $qry1=mysql_query($sql1);
                                    
                                   //log file
					 echo "<font color=red><center><b><br><br>successfully reject Requests </b></center></font>";
