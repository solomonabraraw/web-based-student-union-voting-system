...
if($con)
{
  $sql=mysql_query("insert into preguesstime values('1','$Closedate')");
   if($sql)
    echo "Pregeuss Date is setted sucessfully";
	else
	echo "Pregeuss Date is not setted sucessfully".mysql_error($con);
}
else
