...
<div id="container">
    ...
    <div id="jssor_1" style="position:relative;margin:1px auto;
      top:1px;left:1px;width:2000px;height:1300px;
      overflow:hidden;visibility:hidden;">
        <div data-u="loading" style="position:absolute;top:0px;left:0px;
        background-color:whitesmoke;">
            <div style="filter: alpha(opacity=70); opacity: 0.7; 
            position: absolute; display: block; top: 0px; left: 0px; width: 2000%; height: 2000%;"></div>
            <div style="position:absolute;display:block;
            background:url('img/loading.gif') ;top:0px;left:0px;width:2000%;height:2000%;"></div>
        </div>
        
        <div data-u="slides" style="cursor:default;position:relative;top:0px;
        left:20px;width:1850px;height:1300px;">
            <div>
 ...
 -->             <div>
        ...
        <span data-u="arrowleft" class="jssora02l" style="top:0px;left:8px;width:59px;height:55px;color: black;" data-autocenter="2"><img data-u="image" src="images/cont1.gif" /></span>
