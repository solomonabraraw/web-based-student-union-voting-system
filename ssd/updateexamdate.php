...
<legend align="center" style="color: #336699;"><b><h2>Update Candidates Exam Date</h2></b></legend>
			<?php
...
echo"<tr><td colspan='2'><input type='submit' value='Update' name='Update' id='btn'/>&nbsp;<input type='reset'
			 value='Reset'id='btn'/></td></tr></table></form>";
					 ...
					 if(isset($_POST["Update"]))
									{
						$edate=$_POST['edate'];
						$updated=mysql_query("update examdate set closedate='$edate'");
										if(mysql_affected_rows($con))
										echo " Exam Date Is updated successfully!";
										 else
